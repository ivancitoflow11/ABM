namespace ABM.Models
{
    public class Cl_matriz_diaria
    {
        ...
        public string fechaModAdmin_ex { get; set; }
        ...
        public int? Ccosto_empresa { get; set; }
        public string Nomcosto_empresa { get; set; }
        public int? Codcargo_empresa { get; set; }
        public string Nomcargo_empresa { get; set; }
